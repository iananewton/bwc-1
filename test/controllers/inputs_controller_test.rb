...
class InputsControllerTest < ActionController::TestCase
  ...
  test "should create input" do
    assert_difference('Input.count') do
      post :create, input: { InputItem: @input.InputItem, MasterDataID: @input.MasterDataID, Quantity: @input.Quantity }
    end
  ...
  test "should update input" do
    patch :update, id: @input, input: { InputItem: @input.InputItem, MasterDataID: @input.MasterDataID, Quantity: @input.Quantity }
    assert_redirected_to input_path(assigns(:input))
  end
