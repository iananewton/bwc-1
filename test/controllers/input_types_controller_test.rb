...
class InputTypesControllerTest < ActionController::TestCase
  ...
  test "should create input_type" do
    assert_difference('InputType.count') do
      post :create, input_type: { InputTypeDescription: @input_type.InputTypeDescription, MDType: @input_type.MDType }
    end
  ...
  test "should update input_type" do
    patch :update, id: @input_type, input_type: { InputTypeDescription: @input_type.InputTypeDescription, MDType: @input_type.MDType }
    assert_redirected_to input_type_path(assigns(:input_type))
  end
